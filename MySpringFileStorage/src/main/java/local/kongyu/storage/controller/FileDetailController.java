...
public class FileDetailController {
    ...
    public void getFtpFileList(String filePrefix) {
        // 列出文件
        ListFilesResult files = fileStorageService.listFiles().setPlatform("ftp-1").setFilenamePrefix(filePrefix).listFiles();
        files.getFileList().forEach(file -> {
            ...
            try {
                ...
                String data = StrUtil.str(fileBytes, Charset.defaultCharset());
                System.out.println(StrUtil.format("文件[{}]={}", filename, data));
            } catch (Exception e) {
